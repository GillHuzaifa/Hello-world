...
export class InventoryComponent implements OnInit, OnDestroy {
    ...
    applyFilters(): void {
        ...
        switch (this.medicineStatusFilter) {
            ...
            case 'outOfStock': result = result.filter(m => this.getMedicineStatus(m) === 'Out of Stock'); break;
    ...
    getMedicineStatus(m: Medicine): MedicineStatus | 'Expiring Soon' | 'About to Expire' | 'Out of Stock' {
        if ((m.quantity || 0) === 0) return 'Out of Stock';
